  ...
  <div >
    ...
    <el-form :model="form"  :rules="rules"
      ...
      <el-form-item label="收购编号" class="post">
        <el-input v-model="form.ordersId" :disabled="true"></el-input>
      </el-form-item>
      ...
      <el-form-item label="接待人" class="post">
       <el-input v-model="form.ordersUser" :disabled="true"></el-input>
      </el-form-item>
...
export default {
  data() {
    return {
      ...
      form: {
        ordersId:'',//收购编号
        recordId:'',//登记编号
        ordersTime:this.randomNumber2(),//预约日期
        ordersUser:'',//接待人
        ordersState:'',//预约状态
        acId:'',//归档编号
        ordersNote:'',//沟通内容
  ...
  created() {
    this.form.ordersId="YY"+this.randomNumber()
    this.findUserName();
