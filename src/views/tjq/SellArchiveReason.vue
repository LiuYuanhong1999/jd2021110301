    ...
    <el-container>
      <el-header height="40px">
        <el-form size="mini" inline :model="search">
          <el-form-item label="名称：">
            <el-input type="text" v-model="search.acCause"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-main>
        <el-table :data="tableData.slice((pageno-1)*pageSize,pageno*pageSize)"  style="width: 100%">
          ...
          <el-table-column prop="acId" label="编号" width="55px"></el-table-column>
          <el-table-column prop="acCause" label="名称" />
        </el-table>
...
export default {
  ...
  methods:{
    ...
    load(){
      ...
      this.axios.post("http://localhost:8088/ggarchive/show",this.search).then(v=>{
    ...
    //确定新增
    submitForm(){
      this.entity.acType=2;
      var url="http://localhost:8088/ggarchive";
      if(this.index){
        url="http://localhost:8088/ggarchive/update"
      }
