	...
	<div class="all" style="width: 100%;height: 100%;">
			...
			<el-col :span="23" class="el-center-top-labels" style="border-bottom: 1px solid #e8eaec;">
				<div class="el-select-table-one-s">
					快速检索：<el-select v-model="pageInfo.value" placeholder="请选择" clearable>
						...
						<el-option label="还款人" value="还款人"></el-option>
						<el-option label="还款金额" value="还款金额"></el-option>
		...
		<div class="memorandum" style="margin-top: 20px;display:flex;justify-content: center">
			<el-table :data="empData" border style="width: 1200px;" >
				<el-table-column prop="customerPaydate" label="还款时间" width="240">
				</el-table-column>
				<el-table-column fixed="left" prop="customerOutnumber" label="销售单号" width="240">
				</el-table-column>
				<el-table-column prop="customerMan" label="付款人" width="240">
				</el-table-column>
				<el-table-column prop="customerMoney" label="付款金额" width="240">
				</el-table-column>
				<el-table-column prop="customerPepo" label="收款人" width="240">
				</el-table-column>
				...
				<el-table-column label="操作" align="center">
					<template #default="scope">
						<el-button type="text" size="small" @click="print(scope.row)">打印
						</el-button>
					</template>
				</el-table-column>
			</el-table>
	...
	export default defineComponent({
		...
		methods: {
			...
			selectAllCustomerRecords() {
				const _this = this
				this.axios.get("http://localhost:8088/selectAllCustomerRecord", {
